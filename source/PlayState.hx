...
class PlayState extends MusicBeatState
{
	...
	override function stepHit()
	{
		...
		if (curSong == "Blammed")
		{
			...
			{
				case 440:
					FlxTween.tween.push(FlxTween.tween(FlxG.camera, {zoom: 1.2}, 0.3, {ease: FlxEase.quadInOut, onComplete: function (tween:FlxTween) {defaultCamZoom = 1.2;}}));
				case 44:
					FlxTween.tween.push(FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.3, {ease: FlxEase.quadInOut, onComplete: function (tween:FlxTween) {defaultCamZoom = 1.5;}}));
				case 444:
					FlxTween.tween.push(FlxTween.tween(FlxG.camera, {zoom: 0.9}, 0.3, {ease: FlxEase.quadInOut, onComplete: function (tween:FlxTween) {defaultCamZoom = 0.9;}}));
			}
		}
